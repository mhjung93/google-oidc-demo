 ...
 * tag_c1_x, tag_c1_y, tag_c2, disc_mask, disc_lo[4], disc_hi[4]](23개, 2026-09-22 §4.2 선택 공개)는 회로가 정한다.
 ...
 */
export async function buildCredentialProof({ uid, arid, s_u, blind_u, blind_s, pk_i, attrs, credential, pk_CIA, pk_trace, tree, disclosure = null, wasmPath = WASM_PATH, zkeyPath = ZKEY_PATH }) {
