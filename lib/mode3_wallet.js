...
import { randomScalar, ppid, normalizeAttrs, sessionCommit, compressPoint, MAX_HEIGHT_MAX } from './mode3_credential.js';
import { encryptTag } from './mode3_trace.js';
import { userLeaf, createRevocationTree, MODE3_TREE_DEPTH } from './mode3_revocation.js';
import { buildIMTv2 } from './imt_v2.js';
import {
  registrationCommit, proveUserCred, serializeUserCredProof, userCredRequestMessage, issueRequestMessageV4, pointToStrings,
 ...
 */
export async function buildCredentialProof({ uid, arid, s_u, blind_u, blind_s, pk_i, attrs, credential, pk_CIA, pk_trace, tree, wasmPath = WASM_PATH, zkeyPath = ZKEY_PATH }) {
