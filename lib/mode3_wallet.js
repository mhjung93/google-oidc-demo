...
// 자격증명 V5 는 (Cf_u, Cf_s, max_height, chainid, allowAgent) 위 CIA 서명이고, 폐기 리프는 둘이다(V8, 2026-09-24):
// 사용자 리프 userLeaf(Cf_u) = Poseidon(4, Cf_u) 와 세션 리프 sessionLeaf(Cf_s) = Poseidon(5, Cf_s) — 같은 트리·같은 root.
