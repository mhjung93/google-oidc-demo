 ...
 */
export function payloadDigest({ chainId, wallet, to, value, data, nonce, discMask = 0n, discLo = [0n, 0n, 0n, 0n], discHi = [0n, 0n, 0n, 0n], setSel = 0n, setRoot = 0n }) {
  return ethers.keccak256(ethers.AbiCoder.defaultAbiCoder().encode(
    ['uint256', 'address', 'address', 'uint256', 'bytes', 'uint256', 'uint256', 'uint256[4]', 'uint256[4]', 'uint256', 'uint256'],
    [chainId, wallet, to, value, data, nonce, discMask, discLo, discHi, setSel, setRoot],
  ));
}
